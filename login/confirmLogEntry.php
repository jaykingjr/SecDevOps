...
<!--
	...
	Filename:	confirmLogEntry.php

	Add a new student: register.php -> placing.php -> confirmLogEntry.php -> login.php
...
<div class="frame2">
	...
	<h5>
		You are signed in. Have a good session.
	</h5>	
</div>
</main>
